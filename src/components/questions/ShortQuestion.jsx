  ...
  return (
    <div className="space-y-4">
      <textarea
        ...
        rows={4}
        className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-indigo-400 text-gray-800 text-sm font-medium outline-none transition-all resize-none disabled:bg-gray-50 disabled:cursor-not-allowed"
      />
      ...
      {revealed && !answered && (
        <div className="space-y-3">
          ...
          <p className="text-sm text-center text-gray-500 font-medium">내 답안과 비교하여 스스로 채점하세요</p>
